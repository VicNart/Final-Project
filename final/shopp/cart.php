...
if ($products_in_cart) {
    ...
    foreach ($products as $product) {
        $subtotal += (float)$product['price_in_ghc'] * (int)$products_in_cart[$product['PRODUCT_ID']];
    }
}
?>
                ...
                <tr>
                    <td class="img">
                        <a href="index.php?page=product&PRODUCT_ID=<?=$product['PRODUCT_ID']?>">
                            <img src="imgs/<?=$product['img']?>" width="50" height="50" alt="<?=$product['product_name']?>">
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="price">&dollar;<?=$product['price_in_ghc']?></td>
                    <td class="quantity">
                    ...
                    <td class="price">&dollar;<?=$product['price_in_ghc'] * $products_in_cart[$product['PRODUCT_ID']]?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
